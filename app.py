...
def register():
    """ function to show and process register page """
    if request.method == 'POST':
        username = request.form['username']
        ...
        if user is not None:
            ...
            error = 'Password must be at least 8 characters, one uppercase letter, one lowercase letter, one number, and one special character!'
